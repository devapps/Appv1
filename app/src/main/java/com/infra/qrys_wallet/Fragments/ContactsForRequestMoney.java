 ...
 */
public class ContactsForRequestMoney extends Fragment {
    private FragmentTabHost mTabHost;
    SearchView searchView;
    PhoneBook_SelectUser_Adapter adapter;
    private FragmentManager fragmentManager;
    QRysUserPhoneBook qrysFrag;
    ...
    private class SyncQRysUserContacts extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equals("") || s == null) {
                // prgDialog.dismiss();
                Toast.makeText(ContactsForRequestMoney.this.getActivity(), "Unable to reach server", Toast.LENGTH_LONG).show();
                return;
            } else {
                Log.d(TAG, " Test 2.0 ");
                ...
                try {
                    ...
                    if (opStatus.equals("00")) {
                        setRefreshActionButtonState(false);
                        temp=1;
                        Toast.makeText(ContactsForRequestMoney.this.getActivity(), result, Toast.LENGTH_SHORT).show();
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    return tab2;
                case 1:
                    qrysFrag= new QRysUserPhoneBook();
        ...
        public void setData(){
            qrysFrag= new QRysUserPhoneBook(); //modified
