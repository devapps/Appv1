   ...
   private static CustomerAlreadyReg inst;
    ...
    private class VerifyCustomerAlreadyReg extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Log.d(TAG, " Test 2 on post execution" + s);
            if (s.equals("") || s == null) {
                prgDialog.dismiss();
                ...
                try {
                    ...
                    System.out.println("respParams zcust "+respParams);
                  ...
                  //  userSelectedBank = respObj.getString("bankName");
                    ...
                    System.out.println("Responce Save " + deviceId +" "+emailId+" "+custName+" "+mobileNo+" "+mmid+" "+ifscCode+" "+userAccountNo+" "+shortBankName+" "+cbsType);
